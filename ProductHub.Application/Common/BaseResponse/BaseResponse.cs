...
using ProductHub.Domain.Constants;

namespace ProductHub.Application.Common.BaseResponse;
...
public partial class BaseResponse
{
    ...
    public static BaseResponse Content(JsonElement data) => new(HttpStatusCode.OK, MessageResponse.OkMessage, data);
    ...
    {
        return new BaseResponse(HttpStatusCode.OK, MessageResponse.UpdatedMessage, data);
    }
